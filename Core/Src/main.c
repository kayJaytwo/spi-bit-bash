...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, SPI_DCx_Pin|SPI_CS_Pin|SPI_SCK_Pin|SPI_SDA_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : SPI_DCx_Pin SPI_CS_Pin SPI_SCK_Pin SPI_SDA_Pin */
  GPIO_InitStruct.Pin = SPI_DCx_Pin|SPI_CS_Pin|SPI_SCK_Pin|SPI_SDA_Pin;
